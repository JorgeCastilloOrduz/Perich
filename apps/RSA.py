...
def code(texto_claro_cifrar,clave_cifrar_p,clave_cifrar_q,clave_cifrar_a,clave_cifrar_b):
    ...
    for i in matriz_cifrada:
        matriz_cifrada_aux = [int(i/676),int(i/26), i%26]
        texto_cifrado = texto_cifrado+input_to_letters(matriz_cifrada_aux)

    return texto_claro_cifrar_clean, texto_cifrado

def decode(texto_cifrado_cifrar,clave_descifrar_p,clave_descifrar_q,clave_descifrar_a,clave_descifrar_b):
    texto_cifrado_descifrar_clean = clean_input(texto_cifrado_cifrar).lower()
    lenght=3
    ...
    return texto_cifrado_descifrar_clean.upper(), texto_claro
